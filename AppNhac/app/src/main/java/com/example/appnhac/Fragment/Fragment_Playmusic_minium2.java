...
public class Fragment_Playmusic_minium2 extends Fragment
{
    View view2;
    public static ImageView imageView_hinhbh_playmusic_minium2;
    public static TextView textView_tenbh_playmusic_minium2;
    public static TextView textView_tencasi_playmusic_minium2;
    public static ImageButton imageButton_play_minium2;

    ImageButton imageButton_previous2, imageButton_next2;
    ...
    {
        view2 = inflater.inflate(R.layout.fragment_playmusic_minium, container, false);

        imageView_hinhbh_playmusic_minium2 = view2.findViewById(R.id.imgview_hinh_playmusicminium);
        textView_tenbh_playmusic_minium2 = view2.findViewById(R.id.imgview_tenbh_playmusicminium);
        textView_tencasi_playmusic_minium2 = view2.findViewById(R.id.imgview_tencasi_playmusicminium);
        imageButton_play_minium2 = view2.findViewById(R.id.imagebutton_play_playminium);
        imageButton_previous2 = view2.findViewById(R.id.imagebutton_previous_playminium);
        imageButton_next2 = view2.findViewById(R.id.imagebutton_next_playminium);
        ...
        view2.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if (textView_tenbh_playmusic_minium2.getText().equals("no name") == false)
                {
    ...
    {
        imageButton_play_minium2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                if (textView_tenbh_playmusic_minium2.getText().equals("no name") == false && !isPlay_LastSong)
                {
                    if (mediaPlayer.isPlaying())
                    {
                        ...
                        CreateNotification.createNotification(getContext(), baiHat_isplaying,
    ...
    {
        imageButton_next2.setEnabled(false);
        imageButton_previous2.setEnabled(false);
        ...
        handler.postDelayed(new Runnable()
        {
            ...
            public void run()
            {
                imageButton_next2.setEnabled(true);
                imageButton_previous2.setEnabled(true);
            }
        },1500);
    }
    ...
    {
        imageButton_previous2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
    ...
    {
        imageButton_next2.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
