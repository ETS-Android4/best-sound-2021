...
public class ChuDeAdapter extends RecyclerView.Adapter<ChuDeAdapter.ViewHolder>
{
    ...
    public ChuDeAdapter(Context context, ArrayList<ChuDe> chuDes)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType)
    {
        ...
        View view = layoutInflater.inflate(R.layout.dong_chude,null);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull ChuDeAdapter.ViewHolder holder, int position)
    {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
    {
        ...
        {
            super(itemView);
            imgview_hinhchude = itemView.findViewById(R.id.img_hinh_chude);
