...
public class Fragment_Playmusic_minium extends Fragment
{
    View view;
    public static ImageView imageView_hinhbh_playmusic_minium;
    public static TextView textView_tenbh_playmusic_minium;
    public static TextView textView_tencasi_playmusic_minium;
    public static ImageButton imageButton_play_minium;
    ImageButton imageButton_previous, imageButton_next;
    ...
    {
        view = inflater.inflate(R.layout.fragment_playmusic_minium, container, false);
        ...
        view.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                if (textView_tenbh_playmusic_minium.getText().equals("no name") == false)
                {
    ...
    private void anhxa()
    {
        imageView_hinhbh_playmusic_minium = view.findViewById(R.id.imgview_hinh_playmusicminium);
        textView_tenbh_playmusic_minium = view.findViewById(R.id.imgview_tenbh_playmusicminium);
        textView_tencasi_playmusic_minium = view.findViewById(R.id.imgview_tencasi_playmusicminium);
        imageButton_play_minium = view.findViewById(R.id.imagebutton_play_playminium);
        imageButton_previous = view.findViewById(R.id.imagebutton_previous_playminium);
        imageButton_next = view.findViewById(R.id.imagebutton_next_playminium);
    }

    private void handle_playmusic_minium()
    {
        imageButton_play_minium.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view)
            {
                if (!textView_tenbh_playmusic_minium.getText().equals("no name") && !isPlay_LastSong)
                {
